"""
The `color_sensor` module enables you to write code that reacts to specific
...
def color(port: int) -> int:
    """
    Returns the color value of the detected color. Use the `color` module to
    map the color value to a specific color.
